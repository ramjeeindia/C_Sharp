<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdSheet.aspx.cs" Inherits="ProductionSheet.ProdSheet" %>
            ...
            <table>
                ...
                <tbody>
                    <tr id="row1" runat="server">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlRemark1" runat="server" OnSelectedIndexChanged="ddlRemark1_SelectedIndexChanged"></asp:DropDownList>
                        </td>
                    </tr>
